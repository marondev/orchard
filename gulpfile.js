...
function devFavicons() {
  return src(`${options.paths.src.favicons}/**/*`).pipe(
...
function watchFiles() {
  ...
  watch(`${options.paths.src.favicons}/**/*`, series(devFavicons, previewReload));
...
exports.default = series(
  ...
  parallel(devStyles, devScripts, devImages, devFonts, devFavicons, devHTML), //Run All tasks in parallel
